...
namespace LEGACY
{
	...
	[BepInDependency("LGTuner", BepInDependency.DependencyFlags.HardDependency)]
	...
	[BepInDependency("GTFO.AWO", BepInDependency.DependencyFlags.HardDependency)]
    // removable for Trials:
    ...
    [BepInDependency("Inas.EOSExt.ExtraDoor", BepInDependency.DependencyFlags.HardDependency)]
    [BepInDependency("Inas.EOSExt.LevelSpawnedSentry", BepInDependency.DependencyFlags.HardDependency)]
    [BepInDependency("randomuserhi.AggroFix", BepInDependency.DependencyFlags.HardDependency)]
    [BepInDependency("RLC.ExtraRundownCustomization", BepInDependency.DependencyFlags.HardDependency)]
    [BepInDependency("Dinorush.ExtraToolCustomization", BepInDependency.DependencyFlags.HardDependency)]
    //
